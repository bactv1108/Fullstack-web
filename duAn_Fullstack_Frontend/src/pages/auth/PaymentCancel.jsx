  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-md bg-[#0f0f13] border border-red-500/20 rounded-3xl p-8 text-center shadow-2xl shadow-red-500/5 backdrop-blur-md relative z-10">
        ...
        <div className="w-8 h-8 bg-red-500/10 border border-red-500/20 rounded-full flex items-center justify-center mx-auto mb-6 text-red-400 relative">
          <XCircle size={18} />
        </div>

        {/* Title */}
        <div className="space-y-2 mb-6">
          <div className="!p-2 inline-flex items-center gap-1.5 bg-red-500/10 text-red-400 border border-red-500/20 px-3 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider">
        ...
        <button
          ...
          className="!p-2 !mt-1 w-full py-3.5 bg-zinc-800 hover:bg-zinc-700 text-white font-black uppercase text-xs tracking-widest rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2 border-none shadow-lg active:scale-[0.98]"
        >
          <ArrowLeft size={14} />
